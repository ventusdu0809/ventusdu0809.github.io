      ...
      <section className="content-section" aria-labelledby="pipeline-title">
        <div className="section-shell">
          ...
          <div className="game-feature-grid">
            <article><p className="eyebrow">FMOD / UNITY 资源组织</p><h3>按剧情章节拆分 Bank</h3><p>音乐 Bank 原本约 50 MB。由于自定义 .bank 转 Unity Metadata 与 Byte 数据的链路无法使用 Stream，后续按剧情章节拆分为 50 个约 2 MB 的 Bank，以减少单次加载规模和频繁加载。</p><div className="bank-diagram"><div className="bank-source"><b>原 Music Bank</b><span>约 50 MB</span></div><span className="bank-arrow" aria-hidden="true">→</span><div className="bank-target"><b>50 × 约 2 MB</b><span>按剧情章节组织</span></div></div></article>
