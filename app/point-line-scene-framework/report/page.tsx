    ...
    <main className="pls-paper-page">
      ...
      <div className="paper-layout">
        ...
        <article className="paper-sheet">
          ...
          <section id="conclusion"><h2><span>13</span> 结论 <small>CONCLUSION</small></h2><p>PLS-Eval v2.1 把 P1–P4、L1–L4、S1–S4 保留为稳定能力坐标，再按 Prompt 激活原子评价单元。依赖关系先决定评价资格，PASS、FAIL、BLOCKED、N/A 与 UNEVALUABLE 构成诊断向量，主要输出是失败位置和对应证据。两轮案例中的 3→4→4 说明显式参考链会直接改变错误归因；跨轮状态则区分重复模式、未复现、待细化问题和持续质量关注。人工评测与信号诊断当前作为独立证据分支保存，并由人工分析做对照；结构化连接和自动判断尚未实现。</p></section>
