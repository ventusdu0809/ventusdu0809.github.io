...
export const siteCopy = {
  ...
  heroCopy: {
    ...
    body: "我结合声音制作经验，检查 AI 生成结果的音质、文本符合度和声画一致性，并保留评分、失败案例与复测证据。",
    metrics: [
      { value: "600", label: "T2A 正式样本 · 两阶段累计" },
      { value: "2 轮", label: "音视频受控评测" },
      { value: "16", label: "音视频生成样本" },
    ],
    support: "从实际声音工作出发，逐项检查生成结果",
    primaryCta: "播放代表案例",
  ...
  projectSummary: {
    ...
    finding: "在当前 40 条提示词测试集中，两模型的整体质量与文本符合度未显示明确的总体优势方向。声源、数量和子事件错误为下一轮专项复测提供了线索。",
    boundary: "样本与试听次数为两阶段累计；正式模型比较仅在第二阶段进行。由单一评测人完成，隐藏重复仅检查本人复测稳定性。",
    href: "/t2a-case-study",
    linkLabel: "查看完整案例",
  },
  supportingPractices: {
    ...
    cards: [
      ...
      {
        title: "音频交付与质量控制",
        body: "围绕格式、响度、真实峰值、瞬态、循环零交叉和爆点风险（Click）建立验收检查。",
  ...
  auditTrustLine: {
    ...
    items: [
      {
        name: "T2A 音效生成评测",
        status: "已完成统计复算与文件完整性检查",
        body: "本人复核评分、失败案例与复算结果；完整版本及检查范围见审计说明。",
        href: auditRecordHref,
        linkLabel: "查看 T2A 审计说明",
      },
      {
        name: "音视频生成两轮评测",
        status: "已保留两轮评测与跨轮分析版本",
        body: "保留两轮记录及结论边界，便于回查每项发现的依据。",
  ...
  evaluation: {
    ...
    repeats: {
      ...
      decision: "34 / 40（85.0%）",
      primary: "27 / 40（67.5%）",
      detail: "主分析使用全部 40 对；另以评价顺序间隔 ≥30 的 34 对进行敏感性复核。隐藏重复只说明同一评测人的复测稳定性。",
    },
  },
} as const;
